<h2 align="center">
 <br>
 StockBot: Lightning Fast AI Chatbot that Responds With Live Interactive Stock Charts, Financials, News, Screeners, and More 
 <br>
</h2>
...
> you can run StockBot locally using the quickstart instructions.
